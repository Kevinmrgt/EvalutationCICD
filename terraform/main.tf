...
# VPC pour isoler notre infrastructure
...
# RDS Subnet Group pour la base de données
...
# Instance RDS (optionnelle - peut être remplacée par une base gérée)
